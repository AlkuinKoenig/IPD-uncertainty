...
input_key_xlxs = paste0(here::here(),"/data_input/isotope_keys_testfile_AK_V2.xlsx")
#path to the excel sheet containing information about the samples (peak area, sample volume, etc) and uncertainties
input_data_xlxs = paste0(here::here(),"/data_input/sample_data_testfile_AK_rel_V2.xlsx")
...
write_output_grouped = function(fname_out, df_grouped.s, df_uncertainties_summarised){
  ...
  addWorksheet(wb, sheetName="Overall uncertainties")
  writeData(wb, sheet="Overall uncertainties", df_uncertainties_summarised)
